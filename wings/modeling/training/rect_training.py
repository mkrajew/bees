...
from wings.config import PROCESSED_DATA_DIR, TRAINING_DIR, DEVICE
...
transformer_params = {
    ...
    "checkpoint_save_dir": TRAINING_DIR / "lightning-checkpoints" / transf_model_name / "rectangle_images",
...
resnet_params = {
    ...
    "checkpoint_save_dir": TRAINING_DIR / "lightning-checkpoints" / resnet_model_name / "rectangle_images",
...
if __name__ == "__main__":
    data_dir = PROCESSED_DATA_DIR / "rectangle_datasets"
    train_val_test_datasets = load_datasets(
        [data_dir / 'train_rec_dataset.pth',
         data_dir / 'val_rec_dataset.pth',
         data_dir / 'test_rec_dataset.pth']
    )
