#!/bin/bash
# ==============================================================================
# Online augmentation training -- config 6b (see jobs/online/README.md)
# Loss:    BCEDiceLoss(pos_weight=100, dice_weight=0.5, bce_weight=0.5) -- pos_weight raised further than 6a's 75
...
# ==============================================================================
#SBATCH --job-name=unet-online-k5-6b
...
uv run wings/modeling/training/augmented_unet_6b.py
